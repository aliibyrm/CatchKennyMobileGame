package com.alibayram.kennyyakala;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageDizisi=new ImageView[]{imageView1,imageView2,imageView3,imageView4,imageView5,imageView6,imageView7,imageView8,imageView9};
        kennySakla();
        ...
        new CountDownTimer(10000,1000){
            ...
            public void onFinish() {
                ...
                for(ImageView image:imageDizisi){
    ...
    public void kennySakla(){
        ...
        runnable=new Runnable() {
            ...
            public void run() {
                ...
                imageDizisi[i].setVisibility(View.VISIBLE);
